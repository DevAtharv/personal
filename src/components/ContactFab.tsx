...
export default function ContactFab() {
  ...
  return (
    ...
    >
      <Mail size={24} />
      <span className="absolute right-full mr-3 hidden whitespace-nowrap rounded-full bg-white px-3 py-2 text-sm font-medium text-[#0d253d] shadow-[0_12px_34px_rgba(13,37,61,0.08)] md:block">
        Email me
      </span>
    </motion.a>
  );
