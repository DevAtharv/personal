        ...
        <div className="grid grid-cols-1 gap-8">
          {featuredWork.map((work, index) => (
            <motion.section
              ...
              className="scroll-mt-28 overflow-hidden rounded-xl bg-white shadow-[0_24px_60px_rgba(13,37,61,0.08)]"
            >
              <div className="grid grid-cols-1 lg:grid-cols-[0.85fr_1.15fr]">
                <div className="min-h-80 bg-[radial-gradient(circle_at_22%_10%,rgba(185,185,249,0.55),transparent_16rem),radial-gradient(circle_at_92%_0%,rgba(245,233,212,0.9),transparent_15rem),linear-gradient(145deg,#f6f9fc,#ffffff)] p-6 md:p-8">
